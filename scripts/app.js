...
largeDropdownInput.addEventListener("input", (event) => {
  filterButtonList(event, "ingredient");
});
...
ustensilsSearch.addEventListener("input", (event) => {
  filterButtonList(event, "ustensil");
});
largeDropdownInputU.addEventListener("input", (event) => {
  filterButtonList(event, "ustensil");
});
...
// search appliances
appliancesSearch.addEventListener("input", (event) => {
  filterButtonList(event, "appliance");
});
largeDropdownInputA.addEventListener("input", (event) => {
  filterButtonList(event, "appliance");
});
...
function getFilter(input, largedropdown, type, listOfElement) {
  ...
  for (let i = 0; i < listOfElement.length; i++) {
    ...
    element.setAttribute("hide", "false");
    element.addEventListener("click", function () {
      addATag(listOfElement[i], type, largedropdown, listElements, input);
    });
    element.innerText = listOfElement[i];
    listElements.appendChild(element);
  }
...
function getFilterU(input, largedropdown2, type, listOfElement) {
  ...
  for (let i = 0; i < listOfElement.length; i++) {
    ...
    element.setAttribute("hide", "false");
    element.addEventListener("click", function () {
      addATag(listOfElement[i], type, largedropdown2, listElements, input);
    });
    element.innerText = listOfElement[i];
    listElements.appendChild(element);
  }
...
function getFilterA(input, largedropdown3, type, listOfElement) {
  ...
  for (let i = 0; i < listOfElement.length; i++) {
    ...
    element.setAttribute("hide", "false");
    element.addEventListener("click", function () {
      addATag(listOfElement[i], type, largedropdown3, listElements, input);
    });
    element.innerText = listOfElement[i];
    listElements.appendChild(element);
  }
...
function algo2() {
  ...
  for (let i = 0; i < listOfRecipes.length; i++) {
    ...
    const ingredientsTags = tagsArray.filter(
      (tag) => tag.type === "Ingredient"
    );
    const ingredientsArray = [];
    for (let j = 0; j < listOfRecipes[i].ingredients.length; j++) {
      ingredientsArray.push(
        listOfRecipes[i].ingredients[j].ingredient.toLowerCase()
      );
    }
    ...
    const ustensilsArray = listOfRecipes[i].ustensils.map((item) =>
      item.toLowerCase()
    );
    ...
    for (let k = 0; k < appliancesTags.length; k++) {
      if (
        listOfRecipes[i].appliance.toLowerCase() !==
        appliancesTags[k].name.toLowerCase()
      ) {
        isTagMatch = false;
